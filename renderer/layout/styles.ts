...
export const cls = {
  ...
  splitter: {
    v: css("flex:0 0 6px; cursor:col-resize; background:#3a3a40; z-index:5;") + " " + css.raw(":hover{background:#5a8ab5;}"),
    h: css("flex:0 0 6px; cursor:row-resize; background:#3a3a40; z-index:5;") + " " + css.raw(":hover{background:#5a8ab5;}"),
    active: css("background:#5a8ab5 !important;"),
  },
