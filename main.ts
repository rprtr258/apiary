...
ipcMain.handle("SQLSource.Perform", (_, id: string, read: t.TableRead) => api.SQLSource.Perform(id, read));
...
ipcMain.handle("SQLSource.UpdateTableRows", (_, id: string, tableName: string, pkColumns: string[], updates: t.CellUpdate[]) => api.SQLSource.UpdateTableRows(id, tableName, pkColumns, updates));
ipcMain.handle("SQLSource.BuildTableUpdate", (_, id: string, tableName: string, pkColumns: string[], updates: t.CellUpdate[]) => api.SQLSource.BuildTableUpdate(id, tableName, pkColumns, updates));
