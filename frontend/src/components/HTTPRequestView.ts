...
export interface HTTPRequestViewProps {
  initialRequest: database.HTTPRequest,
  onSend: (request: database.HTTPRequest) => Promise<void>,
  onUpdate?: (request: database.HTTPRequest) => Promise<void>,
