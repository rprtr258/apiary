...
const api: Api = {
  ...
  GRPC: {
    Methods:       (a1: string                        ): Promise<Record<string, string[]>> => ipcRenderer.invoke("GRPC.Methods",       a1        ),
    QueryFake:     (a1: string, a2: string            ): Promise<string>                   => ipcRenderer.invoke("GRPC.QueryFake",     a1, a2    ),
