...
contextBridge.exposeInMainWorld("api", {
  ...
  // GRPCMethods: (arg1:string) => Promise<Array<app.grpcServiceMethods>> = async () => [app.grpcServiceMethods.createFrom({})],
  ...
  // JQ: (arg1:string,arg2:string) => Promise<Array<string>> = async () => [],
  List: () => ipcRenderer.invoke("list-requests"),
  // ListEndpointsHTTPSource: (arg1:string) => Promise<Array<database.EndpointInfo>> = async () => [],
  // ListTablesSQLSource: (arg1:string) => Promise<Array<database.TableInfo>> = async () => [],
